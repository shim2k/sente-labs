...
const PaymentModal: React.FC<PaymentModalProps> = ({ isOpen, onClose, userTokens }) => {
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`group relative px-4 py-2 rounded-lg font-semibold transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed ${pkg.popular
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      {isLoading === pkg.id ? (
                        ...
                        <span className="relative">Buy {pkg.value}</span>
                      )}
                    </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm mt-1">
                  Powered by Paddle. Tokens are added to your account immediately after successful payment.
                  Supports credit cards, PayPal, and other payment methods.
                </p>
              </div>
            </div>
          </div>
