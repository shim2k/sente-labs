      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
        ...
        <div className="bg-gray-800/50 rounded-lg border border-gray-700 p-4 sm:p-6">
          <div className="flex items-center space-x-3 mb-4 sm:mb-6">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-semibold text-gray-100">Steam Account</h2>
              <p className="text-xs sm:text-sm text-gray-400">Required for fetching AOE4 match data</p>
            </div>
          </div>
        ...
        <div className="bg-gray-800/50 rounded-lg border border-gray-700 p-4 sm:p-6">
          <div className="flex items-center space-x-3 mb-4 sm:mb-6">
            ...
            <div>
              <h2 className="text-lg sm:text-xl font-semibold text-gray-100">Discord Account</h2>
              <p className="text-xs sm:text-sm text-gray-400">Optional - for review notifications</p>
            </div>
          </div>
